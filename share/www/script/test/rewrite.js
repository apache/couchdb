...
couchTests.rewrite = function(debug) {
  ...
  var res = CouchDB.request("GET", "/test_suite_db/_design/requested_path/_rewrite/show");
  TEquals("/test_suite_db/_design/requested_path/_rewrite/show", res.responseText, "should return orginal url");

  var res = CouchDB.request("GET", "/test_suite_db/_design/requested_path/_rewrite/show_rewritten");
  TEquals("/test_suite_db/_design/requested_path/_rewrite/show_rewritten", res.responseText, "return orginal url");
}
