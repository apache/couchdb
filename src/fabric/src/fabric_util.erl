...
% Aggregate per-shard index pending data. PerRange has one entry per shard
% range, listing its copies as {true|false = IsPreferred, Pending} pairs, the
% flag indicating whether that's a preferred copy.
