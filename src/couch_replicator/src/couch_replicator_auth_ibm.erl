...
check_interval_ms() ->
    max(0, 1000 * config:get_integer("ibm", "check_interval_secs", 60)).

early_refresh_secs() ->
    max(0, config:get_integer("ibm", "early_refresh_secs", 300)).

jitter_ms() ->
    max(0, 1000 * config:get_integer("ibm", "jitter_secs", 60)).
