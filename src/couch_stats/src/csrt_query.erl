...
run(#query{is_safe = true, matcher = MatcherName, selector = #selector{} = Selector, limit = Limit, aggregation = Aggregation}) ->
...
run(#query{}) ->
    {error, {unsafe_query, "Please use 'unsafe(Query)' instead if you really know what you are doing."}}.
...
unsafe_run(#query{matcher = MatcherName, selector = #selector{} = Selector, limit = Limit, aggregation = Aggregation}) ->
...
when
    AggregationKeys :: aggregation_keys_fun() | binary() | rctx_field() | [binary()] | [rctx_field()].
