...
ensure_csrf_secret() ->
    case couch_config:get("csrf", "secret", undefined) of
        undefined ->
            NewSecret = ?b2l(couch_uuids:random()),
            couch_config:set("csrf", "secret", NewSecret),
            NewSecret;
        Secret -> Secret
    end.
...
max_age() ->
    list_to_integer(couch_config:get("csrf", "timeout", "3600")).
...
csrf_mandatory() ->
    case couch_config:get("csrf", "mandatory", "false") of
        "true" -> true;
        _ -> false
    end.
