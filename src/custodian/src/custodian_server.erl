...
send_unavailable_alert(Count) when is_integer(Count) ->
    os:cmd("send_snmptrap --trap CLOUDANT-DBCORE-MIB::cloudantDbcoreShardsUnavailableEvent cloudantDbcoreShardCount "
           ++ integer_to_list(Count)).

send_impaired_alert(Count) when is_integer(Count) ->
    os:cmd("send_snmptrap --trap CLOUDANT-DBCORE-MIB::cloudantDbcoreShardsImpairedEvent cloudantDbcoreShardCount "
           ++ integer_to_list(Count)).
