defmodule Couch.Session do
  ...
  def get(sess, url, opts \\ [timeout: 60_000]), do: go(sess, :get, url, opts)
  def get!(sess, url, opts \\ [timeout: 60_000]), do: go!(sess, :get, url, opts)
  def put(sess, url, opts \\ [timeout: 60_000]), do: go(sess, :put, url, opts)
  def put!(sess, url, opts \\ [timeout: 60_000]), do: go!(sess, :put, url, opts)
  def post(sess, url, opts \\ [timeout: 60_000]), do: go(sess, :post, url, opts)
  def post!(sess, url, opts \\ [timeout: 60_000]), do: go!(sess, :post, url, opts)
  def delete(sess, url, opts \\ [timeout: 60_000]), do: go(sess, :delete, url, opts)
  def delete!(sess, url, opts \\ [timeout: 60_000]), do: go!(sess, :delete, url, opts)
