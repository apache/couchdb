defmodule CompactGenerationTest do
  ...
  test "do not decrease the max generation" do
    db_path = setup_db(0)
    ...
    Couch.put("/#{@db_name}/_max_generation", body: "1")
  ...
  test "transfer space used from gen 1 to gen 2" do
    setup_db(2)
    ...
    [_, %{ "file" => f, "external" => e, "active" => a }] = Couch.get("/#{@db_name}").body["sizes"]
