...
id_suffix_config() ->
    test_util:source_file("test/etap/041-uuid-gen-id-suffix.ini").
...
test() ->
    ...
    run_test([default_config(), id_suffix_config()], TestUnique),
    ...
    run_test([default_config(), id_suffix_config()], TestMonotonic),
    ...
    TestSuffix = fun() ->
        ...
        etap:is(
            ...
            true,
            "utc_id_suffix ids should have the same suffix."
        )
    end,
    run_test([default_config(), id_suffix_config()], TestSuffix).
...
get_suffix(UUID) ->
    element(2, lists:split(14, binary_to_list(UUID))).
