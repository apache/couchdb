...
.DESCRIPTION
  ...
  -WithNouveau               build the new experimental search module (default false)
...
Param(
    ...
    [ValidateNotNullOrEmpty()]
    [string]$SpiderMonkeyVersion = "128", # select the version of SpiderMonkey to use (default 128)
    [ValidateNotNullOrEmpty()]
